...
import { DotsHorizontalIcon, DownloadIcon, InfoCircledIcon } from '@radix-ui/react-icons'
...
const RowActionDropdown = ({
  ...
  const { setResponseHistoryBatchId } = useStore((state) => ({
    setResponseHistoryBatchId: state.setResponseHistoryBatchId,
  }))

  const modalOpen = () => {
    setResponseHistoryBatchId(record.id)
