...
const tabsItemClasses =
  'w-[172px] h-[56px] text-gray-8 border-gray-8 justify-evenly items-center font-sans font-light transition duration-1000 data-[state=active]:border-blue-12 data-[state=active]:border-b-8 data-[state=active]:text-blue-12 data-[state=active]:text-4 data-[state=active]:font-bold'
