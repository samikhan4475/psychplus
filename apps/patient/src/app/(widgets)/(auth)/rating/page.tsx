  ...
  return (
    <Flex align="center" direction="column" height="100%" justify="center">
      <Flex
        ...
        align="center"
        justify="center"
        className="mb-4 h-[82px] w-[82px] rounded-[14px] bg-[#151b4a]"
      >
        <PsychPlusIcon />
      </Flex>
      ...
      <Flex
        ...
        align="center"
        direction="column"
        className="w-[270px] sm:w-[384px]"
      >
        <Text
          weight="medium"
          align="center"
          className="mb-3 text-[17px] sm:mb-6 sm:text-[24px]"
        >
          Thank you for your visit, please rate your experience
        </Text>
        ...
        <Flex width="100%" justify="center" className="mt-[42px] sm:mt-14">
          <Button
            className="h-16 w-44 cursor-pointer bg-[#151B4A] text-[22px] text-[#ffffff]"
            radius="full"
            size="3"
            mt="3"
