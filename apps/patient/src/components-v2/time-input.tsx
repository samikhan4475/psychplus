      ...
      <Controller
        ...
        render={({
          ...
          <TimeField
            ...
            value={value ?? null}
            onChange={onChange}
            hourCycle={twelveHourFormat ? 12 : 24}
            onBlur={onBlur}
            isInvalid={invalid}
            className="w-full"
          ...
          >
            <Box className="relative flex w-full items-center">
              <DateInput
                className={cn(
                  'flex h-7 w-full items-center overflow-hidden rounded-1 border border-gray-7 px-1 data-[disabled]:cursor-not-allowed data-[disabled]:bg-gray-3',
                  dateInputClass,
                )}
              >
