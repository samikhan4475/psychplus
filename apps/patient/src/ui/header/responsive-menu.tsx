...
import { PreCheckinAssessmentDialog } from '@/features/notifications/ui/pre-checkin-assessment-dialog'
...
const ResponsiveMenu = ({
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Flex
            py="2"
            align="center"
            className="h-[var(--header-height)] w-full"
          >
      ...
      <PreCheckinAssessmentDialog stripeApiKey={stripeApiKey} />
    </>
  )
}
