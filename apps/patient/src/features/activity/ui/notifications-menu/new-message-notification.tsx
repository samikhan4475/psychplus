...
import type { NewMessageActivity } from '../../types'

interface NewMessageNotificationProps {
  data: NewMessageActivity
}

const NewMessageNotification = ({ data }: NewMessageNotificationProps) => (
    ...
    >
      ...
      <Flex direction="column">
        <Text className="text-[12px] xs:text-[13px]">
          New message from{' '}
          <Text className="font-[600]">{data.metadata.from}</Text>
        </Text>
