...
import type { NewLabResultsActivity } from '../../types'

interface NewLabResultsNotificationProps {
  data: NewLabResultsActivity
}

const NewLabResultsNotification = ({
  data,
}: NewLabResultsNotificationProps) => (
  <NextLink href="/health/lab-results">
    <Flex
      align="center"
      p="2"
      gap={{ initial: '3', xs: '4' }}
...
export { NewLabResultsNotification }
