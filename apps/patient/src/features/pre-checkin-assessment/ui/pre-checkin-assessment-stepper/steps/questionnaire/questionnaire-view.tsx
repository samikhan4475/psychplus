...
import { Aims, Dast10, Gad7, HamD, Pcl5, Phq9, SnapIv, Ybocs } from './blocks'
import { Audit } from './blocks/audit'

const sectionComponents = {
  [NoteSectionName.NoteSectionPhq9]: Phq9,
  [NoteSectionName.NoteSectionGad7]: Gad7,
  [NoteSectionName.NoteSectionSnapIV]: SnapIv,
  [NoteSectionName.NoteSectionPcl5]: Pcl5,
  [NoteSectionName.NoteSectionYbocs]: Ybocs,
  [NoteSectionName.NoteSectionAims]: Aims,
