...
const AssessmentAndTreatmnetPlanListTable = () => {
  const { assessmentAndTreatmentPlans } = useStore()

  return (
    <DataTable
      data={assessmentAndTreatmentPlans}
      columns={columns()}
...
const DataTableFooter = (table: Table<AssessmentAndTreatment>) => (
...
export { AssessmentAndTreatmnetPlanListTable }
