...
import { EditManagmentServiceClient } from './edit-management-service-widget-client'
import { Preloader } from './preloader'
import { useStore } from './store'

const EditManagementServiceWidgetServer = async () => {
  noStore()
  ...
  return (
    <>
      ...
      <EditManagmentServiceClient googleApiKey={GOOGLE_MAPS_API_KEY ?? ''} />
    </>
  )
}

export { EditManagementServiceWidgetServer }
