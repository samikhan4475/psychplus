...
import { getIcdCodes } from '@psychplus/assessment-and-treatment-plan/api.client'
import { IcdCodes } from '@psychplus/functional-cognitive'
...
const AssessmentAndTreatmentPlanSearchDropdown = <T extends IcdCodes>({
  initialValue,
  placeholder = 'Search',
  onChange,
  form,
                ...
                <Flex direction="column" py="1" gap="1">
                  <Box className="overflow-hidden rounded-[8px] border border-[lightgray] bg-[white] p-2">
                    <Flex className="mb-3 border-[1px] border-[#C8D6FF] bg-[#EBF3FC] px-4 py-2">
                      ...
                      <Text
                        className="font-semibold flex-1 pl-3"
                        weight="medium"
                      >
                        Description
                      </Text>
...
export { AssessmentAndTreatmentPlanSearchDropdown }
