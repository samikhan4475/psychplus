...
import { PreferredPartnerWorklist } from '@psychplus/preferred-partners'
...
const columns: ColumnDef<any>[] = [
  {
    ...
    cell: ({ row }) => <TableCellLongText text={row.original.firstName} />,
    enableHiding: true,
  },

  {
    ...
    cell: ({ row }) => <TableCellLongText text={row.original.middleName} />,
    enableHiding: true,
  },
...

  {
    ...
    cell: ({ row }) => <TableCellLongText text={row.original.ss} />,
    enableHiding: true,
  },
...

  {
    ...
    enableHiding: false,
    cell: ({ row }) => <RowActionDropdown data={row} actionOf={'worklist'} />,
  },
]
const WorklistUsersTable = ({ data }: { data: PreferredPartnerWorklist[] }) => {
  return (
    <DataTable
      data={data}
      columns={columns}
