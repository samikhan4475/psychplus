    ...
    <>
      <Flex align="center" px="8" py="4" className="border-b border-b-gray-5">
        ...
        <Flex gap="4">
          ...
          <NextLink
            href="galaxy/widgets/problems-list"
            className="hover:underline"
          >
            <Text weight="medium">Problems</Text>
          </NextLink>
          <NextLink
            href="galaxy/widgets/assessment-and-treatment-plan-list"
            className="hover:underline"
          >
            <Text weight="medium">Assessment & Treatment plan</Text>
          </NextLink>
          <NextLink
            href="galaxy/widgets/care-plans"
            className="hover:underline"
          >
            <Text weight="medium">Care Plan</Text>
          </NextLink>
          <NextLink
            href="galaxy/widgets/assigning-authorities"
            className="hover:underline"
          >
            <Text weight="medium">Assigning Authorities</Text>
          </NextLink>
          <NextLink
            href="galaxy/widgets/procedures-list"
            className="hover:underline"
          >
            <Text weight="medium">Procedures</Text>
          </NextLink>
        </Flex>
      </Flex>
