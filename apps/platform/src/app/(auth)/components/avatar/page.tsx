...
const TITLE = 'Avatar'
const DESCRIPTION = 'A profile picture, user initials or fallback icon.'

const AvatarPageComponent = () => (
  <>
    ...
    <Box mb="7">
      <Box mb="3">
        <Heading size="5">Fallback</Heading>
      </Box>
      <Flex gap="2">
        <Avatar fallback="A" />
        <Avatar fallback="AB" />
...
export default AvatarPageComponent
