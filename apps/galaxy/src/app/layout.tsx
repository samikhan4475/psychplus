  ...
  if (auth) {
    const [codesets, permissions, user] = await Promise.all([
      getCodesets([
        ...
        CODESETS.QueryByNextDays,
        CODESETS.ClaimFiltrationDateType,
        CODESETS.PaymentSourceType,
        CODESETS.PaymentMethod,
        ...
        CODESETS.ProcessedAsCode,
        CODESETS.AdjustmentGroupCode,
        CODESETS.PlaceOfSerivce,
        CODESETS.LocationType,
        CODESETS.ContactMadeStatus,
        CODESETS.ReferralSource,
        CODESETS.ParameterAdjustmentStatus,
        CODESETS.TMSCoilType,
        CODESETS.TMSStimulationSite,
        CODESETS.PaymentPostingStatus,
        CODESETS.ResourceStatus,
        CODESETS.ServicesStatus,
        CODESETS.QueryByLastDays,
      ]),
      getUserPermissions(),
      getLoggedInUser(),
    ])
