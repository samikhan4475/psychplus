const USER_PERMISSIONS = {
  ...
  signButtonQuickNotePage: 'signButtonQuickNotePage',
  addToNoteProviderVitalsHistory: 'addToNoteProviderVitalsHistory',
  sendPolicyViaSMSEmailCall: 'sendPolicyViaSMSEmailCall',
  signNote: 'signNote',
  printButtonVisitViewQuickNote: 'printButtonVisitViewQuickNote',
  viewButtonQuestionnaireHistoryPage: 'viewButtonQuestionnaireHistoryPage',
  placeLabOrder: 'placeLabOrder',
  changeStatusFollowupTab: 'changeStatusFollowupTab',
  toggleEmergencyContact: 'toggleEmergencyContact',
  favoriteDiagnosisWorkingDiagnosisTab: 'favoriteDiagnosisWorkingDiagnosisTab',
  savePCP: 'savePCP',
  ...
  viewDetailQuestionnaireDashboardPage: 'viewDetailQuestionnaireDashboardPage',
  sheetViewVitalsTab: 'sheetViewVitalsTab',
  saveReferralAuthorizationPopup: 'saveReferralAuthorizationPopup',
  createNewNoteButtonNotesPage: 'createNewNoteButtonNotesPage',
  replyAllMessageButton: 'replyAllMessageButton',
  ...
  signAdmitReconciliationPopupProvider: 'signAdmitReconciliationPopupProvider',
  printCurrentMedicationsPage: 'printCurrentMedicationsPage',
  addLabResult: 'addLabResult',
  markNoteAsError: 'markNoteAsError',
  dataViewVitalsHistory: 'dataViewVitalsHistory',
  ...
  makePaymentButtonOnPaymentpopup: 'makePaymentButtonOnPaymentpopup',
