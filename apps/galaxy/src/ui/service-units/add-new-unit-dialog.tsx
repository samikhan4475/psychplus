...
import { AddNewUnitForm } from './add-new-unit-form'
...
const AddNewUnitDialog = ({ data }: DialogProps) => {
  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      ...
      <Dialog.Content className="relative max-w-[800px]">
        ...
        <AddNewUnitForm data={data} onCloseModal={onOpenChange} />
      </Dialog.Content>
    </Dialog.Root>
  )
}

export { AddNewUnitDialog }
