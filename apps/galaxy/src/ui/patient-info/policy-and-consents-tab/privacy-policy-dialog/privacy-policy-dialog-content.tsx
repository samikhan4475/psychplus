...
import { useStore as useQuickNotesStore } from '@/ui/quicknotes/store'
import {
  cn,
  getAgeFromDate,
...
interface PrivacyPolicyContentProps extends RowActionProps {
  handleUpdateOpenState: Dispatch<SetStateAction<boolean>>
}
  ...
  return (
    <FormContainer form={form} onSubmit={handleSubmit}>
      ...
      <Box className={cn('shadow-light-gray-08 my-4')}>
        <Flex gap="4" className={cn('border-pp-states-disabled border p-1')}>
          <Flex gap="2">
        ...
        <Box className="h-[366px] px-4 py-2">
          ...
          <Flex className="mt-4 gap-2 bg-[#F9F9FB] p-2">
            <CheckboxInput field="signedByPatient" checked={signedByPatient} />
            <Text size="2" weight="medium">
...
export { PrivacyPolicyDialogContent }
