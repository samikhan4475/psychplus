...
enum QuickNoteSectionName {
  ...
  QuickNoteSectionCars2St = 'QuicknoteSectionQuestionnaireCars2St',
  QuickNoteSectionMdq = 'QuicknoteSectionQuestionnaireMdq',
  ...
  QuicknoteSectionImmunization = 'QuicknoteSectionImmunization',
  QuickNoteSectionVadprs = 'QuicknoteSectionQuestionnaireVadprs',
  QuicknoteSectionPreEmployment = 'QuicknoteSectionPreEmployment',
  QuickNoteSectionBai = 'QuicknoteSectionQuestionnaireBai',
  QuickNoteSectionBdi = 'QuicknoteSectionQuestionnaireBdi',
}
const questionnairesAddToNotesSection = [
  ...
  `${QuickNoteSectionName.AddToNoteQuestionnaire}-${QuickNoteSectionName.QuickNoteSectionMdq}`,
  `${QuickNoteSectionName.AddToNoteQuestionnaire}-${QuickNoteSectionName.QuickNoteSectionCars2St}`,
