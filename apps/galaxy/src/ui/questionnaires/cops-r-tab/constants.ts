...
const SUBSCALES = {
  riskLevel: {
    title: 'Risk Level Scales',
    subscales: [
      {
        name: 'Honesty and Integrity',
        questions: [20, 28, 220],
        desirable: 'T', // T = desirable, F = non-desirable
      },
      {
        name: 'Relations with Public',
        questions: [28, 198],
        desirable: 'T',
      },
      {
        name: 'Rule Compliance',
        questions: [31, 66, 157, 195, 204, 234],
        desirable: 'T',
      },
      {
        name: 'Judgement',
      ...
      {
        name: 'Use of Sick Time',
        questions: [89, 162, 202, 203, 224],
        desirable: 'F', // F = desirable, T = non-desirable
      },
      {
        name: 'Relations with Coworkers',
        questions: [124, 173, 183, 193],
        desirable: 'T',
      },
      {
        name: 'Acceptance of Supervision (SVN)',
        questions: [126, 147, 174],
        desirable: 'T',
      },
      {
        name: 'Productivity',
  ...
  positiveDescriptor: {
    title: 'Positive Descriptor Scales',
    subscales: [
      {
        name: 'Motivation',
        questions: [2, 67, 98, 105, 121, 129, 153, 154, 185, 205, 235, 210],
        desirable: 'T',
      },
      {
        name: 'Success',
        questions: [
          7, 45, 62, 63, 71, 72, 73, 76, 101, 130, 133, 152, 156, 180, 238,
        ],
        desirable: 'T',
      },
      {
        name: 'Social Adjustment',
        questions: [9, 15, 39, 65, 83, 93, 175],
        desirable: 'T',
      },
      {
        name: 'Self-Discipline',
        questions: [59, 60, 75, 119, 120, 135, 137, 155, 189, 206, 210, 216],
        desirable: 'T',
      },
    ],
  },
  negativeDescriptor: {
    title: 'Negative Descriptor Scales',
    subscales: [
      {
        name: 'Family of Origin Conflicts',
        questions: [
          1, 5, 6, 8, 12, 21, 47, 48, 52, 53, 110, 127, 199, 212, 213, 214, 215,
        ],
        desirable: 'F',
      },
      {
        name: 'Antisocial Activities',
        questions: [3, 4, 55, 103, 104, 132, 136, 177, 200, 237],
        desirable: 'F',
      },
      {
        name: 'Negative Work Attitudes',
        questions: [10, 41, 42, 43, 113, 124, 138, 169, 161],
        desirable: 'F',
      },
      {
        name: 'Lack of Integrity',
        questions: [13, 26, 30, 35, 50],
        desirable: 'F',
      },
      {
        name: 'Depression',
        questions: [14, 18, 44, 64, 89, 125, 111, 172, 190, 194, 219],
        desirable: 'F',
      },
      {
        name: 'Substance Abuse',
        questions: [16, 25, 27, 29, 34, 36, 106, 112, 181, 195, 221, 222],
        desirable: 'F',
      },
      {
        name: 'Poor Life Management',
        questions: [17, 24, 46, 80, 82, 207],
        desirable: 'F',
      },
      {
        name: 'Impulsivity',
        questions: [19, 51, 54, 56, 57, 107, 122, 123, 179, 233],
        desirable: 'F',
      },
      {
        name: 'Authoritarianism',
        questions: [22, 32, 94, 178],
        desirable: 'F',
      },
      {
        name: 'Bias',
        questions: [
          23, 33, 40, 49, 58, 74, 79, 90, 118, 140, 142, 143, 160, 168, 184,
          196, 204,
        ],
        desirable: 'F',
      },
      {
        name: 'Opinionated',
        questions: [37, 84, 85, 99],
        desirable: 'F',
      },
      {
        name: 'Paranoid Orientation',
        questions: [38, 61, 102, 114, 116, 192, 211, 233, 231, 237],
        desirable: 'F',
      },
      {
        name: 'Aggression',
        questions: [81, 129, 134, 179, 187, 193, 192, 219, 239, 240],
        desirable: 'F',
      },
      {
        name: 'Worry',
        questions: [
          86, 88, 91, 109, 115, 125, 128, 145, 155, 158, 159, 170, 171,
        ],
        desirable: 'F',
      },
      {
        name: 'Personality Problems',
        questions: [108, 141, 176, 208, 209, 223, 232, 239, 240, 236],
        desirable: 'F',
      },
      {
        name: 'Gender Bias',
        questions: [131, 144, 178, 186, 198, 201, 230, 236],
        desirable: 'F',
      },
    ],
  },
...
export { LABELS, QUESTIONS, SUBSCALES }
