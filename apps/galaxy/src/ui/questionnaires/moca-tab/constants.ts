...
const VISUOSPATIAL_EXECUTIVE = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: '+1 Correctly drew contour only', value: '1' },
      { label: '+1 Correctly drew numbers only', value: '1' },
      { label: '+1 Correctly drew hands only', value: '1' },
...
export { MOCA_LABELS, MOCA_TABLES, MOCA_DENTAL_STATUS_OPTIONS }
