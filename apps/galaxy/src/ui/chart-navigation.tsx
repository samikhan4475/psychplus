    ...
    <Box className="bg-white mb-4 w-[160px] rounded-1 shadow-2">
      <ScrollArea>
        <Flex direction="column">
          ...
          <NavigationLink href="/questionnaires">Questionnaires</NavigationLink>
          ...
          <NavigationLink href="/assessment">Assessment & Plan</NavigationLink>
          ...
          <NavigationLink href="/treatment-plan">Treatment Plan</NavigationLink>
          ...
          <NavigationLink href="/notification">Notification</NavigationLink>
