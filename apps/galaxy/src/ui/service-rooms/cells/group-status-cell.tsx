...
const ServiceRoomHistoryDialog = ({ row }: PropsWithRow<ServiceRoom>) => {
  ...
  const onStatusChange = async (value: string) => {
    setLoading(true)
    setStatus(value)
    const response = await updateServiceRoomAction(
      {
        ...row.original,
...
export { ServiceRoomHistoryDialog }
