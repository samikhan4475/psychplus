...
const TeleStateCosigner = ({
  ...
  return (
    <Flex align="center" gapX="1">
      ...
      <LongTextCell>
        {data
          ?.filter((state) => state.cosigner)
          .map((state) => state.cosigner)
          .join(', ')}
      </LongTextCell>
    </Flex>
  )
