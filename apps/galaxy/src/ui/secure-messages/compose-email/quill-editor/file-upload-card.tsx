...
const FileUplaodCard = ({ attachment, handleDeleteFile }: FileTileProps) => {
  const hasError = false
  return (
    <Flex
      className={cn(
        `group h-[56px] w-[192px] cursor-pointer items-center justify-between  rounded-[12px] border p-[12px]`,
        hasError
