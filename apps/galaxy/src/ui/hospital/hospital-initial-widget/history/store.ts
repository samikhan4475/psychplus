...
interface Store {
  ...
  hospitalInititalHistory?: QuickNoteHistory[]
  fetchHospitalInititalHistories: (
    patientId: string,
...
const useStore = create<Store>((set) => ({
  ...
  hospitalInititalHistory: [],

  fetchHospitalInititalHistories: async (
    patientId: string,
    sectionName: QuickNoteSectionName,
    formValues?: Partial<SchemaType>,
  ) => {
    ...
    set({
      hospitalInititalHistory: histories,
  ...
  setHospitalInitialHistory: (history: QuickNoteHistory[]) =>
    set({ hospitalInititalHistory: history }),
}))
