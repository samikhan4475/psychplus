...
interface TransferingFacilityStatusCelltype {
  readonly status: string

}

function TransferingFacilityStatusCell({ status }: TransferingFacilityStatusCelltype) {
...
export default TransferingFacilityStatusCell
