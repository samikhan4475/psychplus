...
export enum TypeOfThetaBurst {
  ContinuesThetaBurst = 'Continuous Theta Burst Stimulation (cTBS)',
  IntermittentThetaBurst = 'Intermittent Theta Burst Stimulation (cTBS)',
}
