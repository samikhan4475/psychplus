...
import { ClaimNotesRowAction } from './action-cell'
import { ClaimNotesAlertCell } from './alert-cell'
import { ClaimNotesCell } from './notes-cell'

const columns = (claimId: string): ColumnDef<ClaimNotesResponse>[] => {
  return [
    {
      id: 'note',
      accessorKey: 'note',
    ...
    },
    {
      ...
      cell: ({ row }) => <ClaimNotesRowAction claimId={claimId} row={row} />,
      enableHiding: false,
      size:100
    },
  ]
